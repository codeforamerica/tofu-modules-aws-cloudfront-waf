...
- updating CloudWatch minimum TLS policy (WRSAT-670) (#52)

## 2.4.0 (2026-07-01)

### Feat

- Add support for path-based redirects via ordered cache behaviors. (#49)
...
- Add WAF data protection configuration. (#44)
